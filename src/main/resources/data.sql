...
VALUES
    (1,'test1@example.com', '$2a$10$pngHXjZ3FV/fB1P6GTBTgOysuGXyXs4/E8G2dUo5JuLFmMmnZt9kq', '사용자1', NOW(), NOW()), --비밀번호 :test
    (2, 'test2@example.com', '$2a$10$pngHXjZ3FV/fB1P6GTBTgOysuGXyXs4/E8G2dUo5JuLFmMmnZt9kq', '사용자2', NOW(), NOW()); --비밀번호 :test

-- Images
INSERT INTO images (
    image_id,image_name, version, docker_base_image, build_command, run_command, template_code, created_at, updated_at
)
VALUES (
           1,'Java', '17', 'openjdk:21', 'javac Main.java', 'java Main',
